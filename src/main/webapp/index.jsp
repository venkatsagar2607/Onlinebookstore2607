...
<head>
	...
	<title>INFINITE BOOKS STORE</title>
...
<body>
	...
	<div class="wrapper" id="wrapper">
        ...
        <div class="slider-area brown__nav slider--15 slide__activation slide__arrow01 owl-carousel owl-theme">
        	<!-- Start Single Slide -->
	        <div class="slide animation__style10 bg-image--15 fullscreen align__center--left">
	            <div class="container">
	            	<div class="row">
	            		<div class="col-lg-12">
			...
			<div class="container">
				...
				<div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.jsp"><img src="images/Book4.jpg" alt="product image" width="270" height="340"></a>
								<a class="second__img animation1" href="single-product.jsp"><img src="images/Book4.jpg" alt="product image"></a>
								<div class="hot__box">
							...
							<div class="product__content content--center">
								...
								<ul class="prize d-flex">
									<li>&#8377 40.00</li>
									<li class="old_prize">&#8377 35.00</li>
								</ul>
								<div class="action">
									<div class="actions_inner">
										<ul class="add_to_links">
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.jsp"><img src="images/Book7.jpg" alt="product image" width="270" height="340"></a>
								<a class="second__img animation1" href="single-product.jsp"><img src="images/Book7.jpg" alt="product image"></a>
								<div class="hot__box">
									<span class="hot-label">HOT</span>
								</div>
							</div>
							<div class="product__content content--center">
								<h4><a href="single-product.jsp">Doctor Wldow</a></h4>
								<ul class="prize d-flex">
									<li>$35.00</li>
									<li class="old_prize">$35.00</li>
								</ul>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.jsp"><img src="images/Book6.jpg" alt="product image" width="270" height="340"></a>
								<a class="second__img animation1" href="single-product.jsp"><img src="images/Book6.jpg" alt="product image"></a>
								<div class="hot__box">
		...
		<section class="wn__newsletter__area bg-image--11">
			<div class="container">
				<div class="row">
		...
		<section class="best-seel-area pt--80 pb--60">
			...
			<div class="slider center">
				...
				<div class="product product__style--3">
					<div class="product__thumb">
						<a class="first__img" href="single-product.jsp"><img src="images/best-sell-product/product1.jpg" alt="product image"></a>
					</div>
					<div class="product__content content--center">
						<div class="action">
							<div class="actions_inner">
				...
				<div class="product product__style--3">
					<div class="product__thumb">
						<a class="first__img" href="single-product.jsp"><img src="images/best-sell-product/product2.jpg" alt="product image"></a>
					</div>
					<div class="product__content content--center">
						<div class="action">
							<div class="actions_inner">
				...
				<div class="product product__style--3">
					<div class="product__thumb">
						<a class="first__img" href="single-product.jsp"><img src="images/best-sell-product/product3.jpg" alt="product image"></a>
					</div>
					<div class="product__content content--center">
						<div class="action">
							<div class="actions_inner">
				...
				<div class="product product__style--3">
					<div class="product__thumb">
						<a class="first__img" href="single-product.jsp"><img src="images/best-sell-product/product4.jpg" alt="product image"></a>
					</div>
					<div class="product__content content--center">
						<div class="action">
							<div class="actions_inner">
				...
				<div class="product product__style--3">
					<div class="product__thumb">
						<a class="first__img" href="single-product.jsp"><img src="images/best-sell-product/product5.png" alt="product image"></a>
					</div>
					<div class="product__content content--center">
						<div class="action">
							<div class="actions_inner">
				...
				<div class="product product__style--3">
					<div class="product__thumb">
						<a class="first__img" href="single-product.jsp"><img src="images/best-sell-product/product6.jpg" alt="product image"></a>
					</div>
					<div class="product__content content--center">
						<div class="action">
							<div class="actions_inner">
				...
				<div class="product product__style--3">
					<div class="product__thumb">
						<a class="first__img" href="single-product.jsp"><img src="images/best-sell-product/product9.jpg" alt="product image" ></a>
					</div>
					<div class="product__content content--center">
						<div class="action">
							<div class="actions_inner">
				...
				<div class="product product__style--3">
					<div class="product__thumb">
						<a class="first__img" href="single-product.jsp"><img src="images/best-sell-product/product8.png" alt="product image"></a>
					</div>
					<div class="product__content content--center">
						<div class="action">
							<div class="actions_inner">
